...
class LoginPage extends StatelessWidget {
  ...
  void signIn(BuildContext context, PhotosLibraryApiModel apiModel) async{
    print("Debut connexion google photo");
    var res = await apiModel.signIn() ;
    if (res!= null){
      print("navigation trip list");
      _navigateToTripList(context);
      return ;
    }
